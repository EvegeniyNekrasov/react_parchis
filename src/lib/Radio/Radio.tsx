...
const Radio: React.FC<RadioProps> = ({ name, value, disabled, onChange, text, color = '#030303' }) => {
    return (
        <Label>
            <Input type="radio" name={name} value={value} disabled={disabled} onChange={onChange} />
